...
| O(n) | Linear time | <li>1-level loop<li>Tree/Graph traversal (each node is visited exactly once)<li>Linear data structures (array, linked list) traversal<li>Stack/Queue<li>Prefix sum array |
