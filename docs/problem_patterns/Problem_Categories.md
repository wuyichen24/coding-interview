...
## Main data structure
> Click the links below to see more specific categories under each data structure
...
- **Intevals**
   - *Check properties*
      ...
      - [Minimum Number of Non-Overlapping Intervals](../problems/intervals/Minimum_Number_Of_Non_Overlapping_Intervals.md) (LC452 Minimum Number of Arrows to Burst Balloons)
   - *Manipulation*
      - Deoverlapping
