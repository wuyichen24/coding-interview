...
- **Path**
   - Root-to-leaf Paths
      - [Is Weight Sum of Root-to-leaf Path Equal to Target Value](../../problems/tree/Is_Weight_Sum_Of_Root_To_Leaf_Path_Equal_To_Target_Value.md)
   ...
   - Node-to-node Paths
      ...
      - [Get Maximum Weight Sum of Path from Binary Tree](../../problems/tree/Get_Maximum_Weight_Sum_Of_Path_From_Binary_Tree)
